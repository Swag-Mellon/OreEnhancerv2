 ...
 *
 */
package net.mcreator.oreenhancer;
...
@Mod("oreenhancer")
public class OreenhancerMod {
	public static final Logger LOGGER = LogManager.getLogger(OreenhancerMod.class);
	public static final String MODID = "oreenhancer";
